// I copied these interfaces from the nestjs-typeorm-paginate package as want to use it on the front-end as well without importing the whole package into the front-end.
